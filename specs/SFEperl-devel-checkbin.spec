...
%define sfe_cpan_name devel-checkbin
%define ips_cpan_name devel-checkbin
...
Source0:               http://cpan.metacpan.org/authors/id/T/TO/TOKUHIROM/Devel-CheckBin-%{version}.tar.gz
