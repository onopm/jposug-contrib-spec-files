...
%define sfe_cpan_name time-local
%define ips_cpan_name time-local
...
Source0:               http://cpan.metacpan.org/authors/id/D/DR/DROLSKY/Time-Local-%{version}.tar.gz
...
%changelog
* Wed Mar 14 2020 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.30 and only build for JPOSUG perl packages
* Wed May 30 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.25 and add packages for perl-5{22,26{,jposug}}
