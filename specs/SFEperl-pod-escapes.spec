...
%define sfe_cpan_name pod-escapes
%define ips_cpan_name pod-escapes
...
License:               perl_5
URL:                   https://metacpan.org/pod/Pod::Escapes
...
- bump to 1.07 and add packages for perl-5{10,16,22,26{,jposug}}
