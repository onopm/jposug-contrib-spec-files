...
%define ips_cpan_name yaml-libyaml

Summary:               Perl YAML Serialization using XS and libyaml
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               0.77
IPS_component_version: 0.77
License:               perl_5
URL:                   https://metacpan.org/pod/YAML::LibYAML
Source0:               http://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-LibYAML-%{version}.tar.gz
...
Requires:         jposug/library/text/yaml
...
- bump to 0.77 and add packages for perl-{522,526,526jposug}
