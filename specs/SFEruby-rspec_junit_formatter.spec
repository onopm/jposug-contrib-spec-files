...
%define sfe_gemname rspec-junit-frm

Summary:          RSpec results that your continuous integration service can read.
...
- bump to 0.3.0 and build packages for ruby-2{3,4,5}jposug
