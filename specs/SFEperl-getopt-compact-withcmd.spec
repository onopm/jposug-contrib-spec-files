...
%define cpan_name Getopt-Compact-WithCmd
%define sfe_cpan_name getopt-compact-withcmd
%define ips_cpan_name getopt-compact-withcmd

Summary:               sub-command friendly, like Getopt::Compact
Name:                  perl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               0.22
IPS_component_version: 0.22
License:               perl_5
URL:                   https://metacpan.org/pod/Getopt::Compact::WithCmd
Source0:               http://cpan.metacpan.org/authors/id/X/XA/XAICRON/Getopt-Compact-WithCmd-%{version}.tar.gz
