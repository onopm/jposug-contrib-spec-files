...
Version:          0.5.1
License:          GPL
URL:              https://github.com/devrandom/net_dav
...
# nokogiri >= 0
Requires:         jposug/library/ruby/nokogiri-23jposug
...
# nokogiri >= 0
Requires:         jposug/library/ruby/nokogiri-24jposug
Requires:         jposug/library/ruby/%{gemname}
...
# nokogiri >= 0
Requires:         jposug/library/ruby/nokogiri-25jposug
Requires:         jposug/library/ruby/%{gemname}
...
%changelog
* Thu Jan 18 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 0.5.1 and build packages for ruby-2{3,4,5}jposug
