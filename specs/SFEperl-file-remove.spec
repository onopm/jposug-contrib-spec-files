...
%define sfe_cpan_name file-remove
%define ips_cpan_name file-remove

Summary:               Remove files and directories
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               1.57
IPS_component_version: 1.57
License:               perl_5
URL:                   https://metacpan.org/pod/File::Remove
Source0:               http://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/File-Remove-%{version}.tar.gz
...
- bump to 1.57 and build packages for perl-52{2,6,6jposug}
