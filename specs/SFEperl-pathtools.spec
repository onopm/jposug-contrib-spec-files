...
- bump to 3.75 and build only for JPOSUG Perl packages
* Mon May 21 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 3.74 and build packages for perl-526{,jposug}
