...
%if %{enable_test}
BuildRequires:    jposug/library/perl-5/pod-simple-530jposug
%endif
Requires:         runtime/perl-530jposug = *
# Requires:         jposug/library/perl-5/%{ips_cpan_name}
Requires:         jposug/library/perl-5/pod-simple-530jposug
...
- bump to 4.14 and only build for JPOSUG perl packages
