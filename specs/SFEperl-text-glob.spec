...
%define sfe_cpan_name text-glob
%define ips_cpan_name text-glob
...
License:               perl_5
URL:                   https://metacpan.org/pod/Text::Glob
Source0:               http://cpan.metacpan.org/authors/id/R/RC/RCLAMP/Text-Glob-%{version}.tar.gz
