...
%if %{build56}
%package 56
IPS_package_name:	web/php/extension/php-mail-56
BuildRequires:		web/php-56 = *
BuildRequires:		web/php/extension/php-net-smtp-56
Requires:			web/php-56 = *
Requires:			web/php/extension/php-net-smtp-56
%define pear_dir_56 %(/usr/php/5.6/bin/pear config-get php_dir)

%package 56-old
IPS_package_name:	web/php-56/extension/php-mail
%define _use_internal_dependency_generator 0
IPS_legacy:			false
Meta(pkg.renamed):	true
PkgBuild_Make_Empty_Package: true
Renamed_To:			web/php/extension/php-mail-56 = *
%endif

%if %{build71}
%package 71
IPS_package_name:	web/php/extension/php-mail-71
BuildRequires:		web/php-71 = *
BuildRequires:		web/php/extension/php-net-smtp-71
Requires:			web/php-71 = *
Requires:			web/php/extension/php-net-smtp-71
%define pear_dir_71 %(/usr/php/7.1/bin/pear config-get php_dir)
%endif

%if %{build72}
%package 72
IPS_package_name:	web/php/extension/php-mail-72
BuildRequires:		web/php-72 = *
BuildRequires:		web/php/extension/php-net-smtp-72
Requires:			web/php-72 = *
Requires:			web/php/extension/php-net-smtp-72
%define pear_dir_72 %(/usr/php/7.2/bin/pear config-get php_dir)
%endif

%if %{build71jposug}
%package 71jposug
IPS_package_name:	web/php/extension/php-mail-71jposug
BuildRequires:		web/php-71jposug = *
BuildRequires:		web/php/extension/php-net-smtp-71jposug
Requires:			web/php-71jposug = *
Requires:			web/php/extension/php-net-smtp-71jposug
%define pear_dir_71jposug %(/opt/jposug/php/7.1/bin/pear config-get php_dir)
%endif

%if %{build72jposug}
%package 72jposug
IPS_package_name:	web/php/extension/php-mail-72jposug
BuildRequires:		web/php-72jposug = *
BuildRequires:		web/php/extension/php-net-smtp-72jposug
Requires:			web/php-72jposug = *
Requires:			web/php/extension/php-net-smtp-72jposug
...
%{pear_dir_71jposug}/*
%{pear_dir_71jposug}/.registry/mail.reg
%endif
...
%{pear_dir_72jposug}/*
%{pear_dir_72jposug}/.registry/mail.reg
%endif
