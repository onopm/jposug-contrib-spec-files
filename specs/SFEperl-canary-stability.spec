...
%define sfe_cpan_name canary-stability
%define ips_cpan_name canary-stability
...
Source0:               http://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/Canary-Stability-%{version}.tar.gz
