...
%define sfe_cpan_name test-pod
%define ips_cpan_name test-pod
...
Source0:               http://cpan.metacpan.org/authors/id/E/ET/ETHER/Test-Pod-%{version}.tar.gz
...
- bump to 1.52 and add packages for perl-526{,jposug}
