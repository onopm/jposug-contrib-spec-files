...
%define tarball_version  2.2.7
%define tarball_name     memcache

Name:                    SFEphp55-memcache
IPS_package_name:	 web/php-55/extension/php-memcache
Summary:                 PHP 5.5 module for MEMCACHE
Version:                 2.2.7
License:		 PHP License
...
cp modules/memcache.so $RPM_BUILD_ROOT/%{_prefix}/php/%{php_version}/lib/extensions/no-debug-non-zts-20121212/
...
%attr(0444, root, bin) %{_prefix}/php/%{php_version}/lib/extensions/no-debug-non-zts-20121212/memcache.so
