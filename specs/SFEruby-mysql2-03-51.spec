#
# spec file for package SFEruby-mysql2-03
# gem install mysql2 (0.3.x)
#
%include Solaris.inc
...
Name: SFEruby-%{gemname}-03-51
IPS_package_name:        library/ruby/mysql2-03/mysql-51
SUNW_Copyright:   %name.copyright
Version: 0.3.16
License: MIT License
URL: http://rubygems.org/gems/%{gemname}
Source0: http://rubygems.org/downloads/%{gemname}-%{version}.gem
Source1: %{name}-mysql2-0.3.11.gemspec
Patch0:  %{name}-0.3.11.patch
Patch1:  %{name}-0.3.16.patch
...
%if %with_ruby18
%package 18
IPS_package_name: library/ruby-18/mysql2-03/mysql-51
Summary: A simple, fast Mysql library for Ruby, binding to libmysql
BuildRequires:  runtime/ruby-18
Requires:       runtime/ruby-18
Requires:       %pnm_requires_mysql51lib
Requires:	library/ruby/mysql2-03/mysql-51
...
%package 19
IPS_package_name: library/ruby-19/mysql2-03/mysql-51
Summary: A simple, fast Mysql library for Ruby, binding to libmysql
...
%if %with_ruby20
#%package 20
#IPS_package_name: library/ruby-20/mysql2-03/mysql-51
#Summary: A simple, fast Mysql library for Ruby, binding to libmysql
