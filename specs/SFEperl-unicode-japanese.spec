...
%define cpan_name Unicode-Japanese
%define sfe_cpan_name unicode-jp
%define ips_cpan_name unicode-japanese
...
License:               perl_5
URL:                   https://metacpan.org/pod/Unicode::Japanese
Source0:               http://cpan.metacpan.org/authors/id/H/HI/HIO/Unicode-Japanese-%{version}.tar.gz
...
%endif
    ...
    ${bindir}/perl -I./ Makefile.PL PREFIX=${prefix} \
