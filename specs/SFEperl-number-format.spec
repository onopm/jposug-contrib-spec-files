...
%define sfe_cpan_name number-format
%define ips_cpan_name number-format

Summary:               Perl extension for formatting numbers
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               1.75
IPS_component_version: 1.75
License:               perl_5
URL:                   https://metacpan.org/pod/Number::Format
Source0:               http://cpan.metacpan.org/authors/id/W/WR/WRW/Number-Format-%{version}.tar.gz
...
- bump to 1.75 and build packages for perl-510, perl-516 and perl-520
