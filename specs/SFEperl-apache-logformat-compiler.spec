...
%define sfe_cpan_name apache-lf-comp
%define ips_cpan_name apache-logformat-compiler

Summary:               Compile a log format string to perl-code 
Name:                  perl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               0.35
IPS_component_version: 0.35
License:               perl_5
URL:                   https://metacpan.org/pod/Apache::LogFormat::Compiler
Source0:               http://cpan.metacpan.org/authors/id/K/KA/KAZEBURO/Apache-LogFormat-Compiler-%{version}.tar.gz
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-mocktime-584
BuildRequires:    library/perl-5/test-requires-584
BuildRequires:    library/perl-5/test-simple-584
BuildRequires:    library/perl-5/posix-strftime-compiler-584
BuildRequires:    library/perl-5/time-local-584
%endif
Requires:         runtime/perl-584 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/posix-strftime-compiler-584
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-mocktime-510
BuildRequires:    library/perl-5/test-requires-510
BuildRequires:    library/perl-5/test-simple-510
BuildRequires:    library/perl-5/posix-strftime-compiler-510
BuildRequires:    library/perl-5/time-local-510
%endif
Requires:         runtime/perl-510 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/posix-strftime-compiler-510
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-mocktime-512
BuildRequires:    library/perl-5/test-requires-512
BuildRequires:    library/perl-5/test-simple-512
BuildRequires:    library/perl-5/posix-strftime-compiler-512
BuildRequires:    library/perl-5/time-local-512
%endif
Requires:         runtime/perl-512 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/posix-strftime-compiler-512
...
Requires:         library/perl-5/%{ips_cpan_name}
%if %{enable_test}
BuildRequires:    library/perl-5/test-mocktime-516
BuildRequires:    library/perl-5/test-requires-516
BuildRequires:    library/perl-5/test-simple-516
BuildRequires:    library/perl-5/posix-strftime-compiler-516
BuildRequires:    library/perl-5/time-local-516
%endif
Requires:         runtime/perl-516 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/posix-strftime-compiler-516
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-mocktime-522
BuildRequires:    library/perl-5/test-requires-522
BuildRequires:    library/perl-5/test-simple-522
BuildRequires:    library/perl-5/posix-strftime-compiler-522
BuildRequires:    library/perl-5/time-local-522
%endif
Requires:         runtime/perl-522 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/posix-strftime-compiler-522
Requires:         library/perl-5/time-local-522
...
BuildRequires:    library/perl-5/module-build-tiny-526
BuildRequires:    library/perl-5/try-tiny-526
BuildRequires:    library/perl-5/uri-526
%if %{enable_test}
BuildRequires:    library/perl-5/test-mocktime-526
BuildRequires:    library/perl-5/test-requires-526
BuildRequires:    library/perl-5/test-simple-526
BuildRequires:    library/perl-5/posix-strftime-compiler-526
BuildRequires:    library/perl-5/time-local-526
%endif
Requires:         runtime/perl-526 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/posix-strftime-compiler-526
Requires:         library/perl-5/time-local-526
...
BuildRequires:    library/perl-5/module-build-tiny-526jposug
BuildRequires:    library/perl-5/try-tiny-526jposug
BuildRequires:    library/perl-5/uri-526jposug
%if %{enable_test}
BuildRequires:    library/perl-5/test-mocktime-526jposug
BuildRequires:    library/perl-5/test-requires-526jposug
BuildRequires:    library/perl-5/test-simple-526jposug
BuildRequires:    library/perl-5/posix-strftime-compiler-526jposug
BuildRequires:    library/perl-5/time-local-526jposug
%endif
Requires:         runtime/perl-526jposug = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/posix-strftime-compiler-526jposug
Requires:         library/perl-5/time-local-526jposug
...
%changelog
* Wed May 30 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 0.35 and add packages for perl-5{22,26{,jposug}}
* Fri Nov 13 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 0.32 and build packages for perl-510, perl-516 and perl-520
