...
%define sfe_cpan_name appconfig
%define ips_cpan_name appconfig
...
Source0:               http://cpan.metacpan.org/authors/id/N/NE/NEILB/AppConfig-%{version}.tar.gz
...
- add packages for perl-{522,526,526jposug}
