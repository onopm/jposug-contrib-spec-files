#
# spec file for package: SFEperl-test-sharedfork
#
...
%define tarball_name    Test-SharedFork

Name:		SFEperl-test-sharedfork
IPS_package_name: library/perl-5/test-sharedfork
Version:	0.20
IPS_component_version: 0.20
Summary:	Test-SharedFork
License:	Artistic
...
Source0:	http://search.cpan.org/CPAN/authors/id/T/TO/TOKUHIROM/Test-SharedFork-%{tarball_version}.tar.gz
...
# %package 584
# IPS_package_name: library/perl-5/test-sharedfork-584
# Summary: Test-SharedFork for perl-584
# BuildRequires:	runtime/perl-584
...
%package 512
IPS_package_name: library/perl-5/test-sharedfork-512
Summary: Test-SharedFork for perl-512
BuildRequires:	runtime/perl-512
