...
%define cpan_name File-Zglob
%define sfe_cpan_name file-zglob
%define ips_cpan_name file-zglob
...
Source0:               http://cpan.metacpan.org/authors/id/T/TO/TOKUHIROM/File-Zglob-%{version}.tar.gz
