...
%define sfe_cpan_name params-validate
%define ips_cpan_name params-validate

Summary:               Validate method/function parameters
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               1.21
IPS_component_version: 1.21
License:               artistic_2
URL:                   https://metacpan.org/pod/Params::Validate
Source0:               http://cpan.metacpan.org/authors/id/D/DR/DROLSKY/Params-Validate-%{version}.tar.gz
...
- bump to 1.21 and build packages for perl-510, perl-516 and perl-520
