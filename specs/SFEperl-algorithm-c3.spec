#
# spec file for package: SFEperl-algorithm-c3
#
...
%define tarball_name    Algorithm-C3

Name:		SFEperl-algorithm-c3
IPS_package_name: library/perl-5/algorithm-c3
Version:	0.08
IPS_component_version: 0.8
Summary:	Algorithm::C3
License:	Artistic
...
Source0:	http://search.cpan.org/CPAN/authors/id/F/FL/FLORA/Algorithm-C3-%{tarball_version}.tar.gz
...
# %package 584
# IPS_package_name: library/perl-5/algorithm-c3-584
# Summary: Algorithm::C3 for perl-584
# BuildRequires:	runtime/perl-584
# Requires:	runtime/perl-584

%package 512
IPS_package_name: library/perl-5/algorithm-c3-512
Summary: Algorithm::C3 for perl-512
BuildRequires:	runtime/perl-512
