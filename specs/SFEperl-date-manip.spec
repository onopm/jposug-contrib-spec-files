...
%define sfe_cpan_name date-manip
%define ips_cpan_name date-manip

Summary:               Date manipulation routines
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               6.70
IPS_component_version: 6.70
License:               perl_5
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-inter-526
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-inter-526jposug
...
- bump to 6.70 and add packages for perl-526{,jposug}
