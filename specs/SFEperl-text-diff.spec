...
%define ips_cpan_name text-diff
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/algorithm-diff-510
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/algorithm-diff-522
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/algorithm-diff-526
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/algorithm-diff-526jposug
...
- bump to 1.45 and add packages for perl-{510,522,526,526jposug}
