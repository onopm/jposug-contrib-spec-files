...
%define cpan_name inc-latest
%define sfe_cpan_name inc-latest
%define ips_cpan_name inc-latest
...
Source0:               http://cpan.metacpan.org/authors/id/D/DA/DAGOLDEN/inc-latest-%{version}.tar.gz
...
- add packages for perl-5{10,22,26{,jposug}}
