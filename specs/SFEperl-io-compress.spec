...
%if %{enable_test}
BuildRequires:    jposug/library/perl-5/compress-raw-bzip2-530jposug
...
Requires:         jposug/library/perl-5/compress-raw-bzip2-530jposug
...
- bump to 2.093 and only build for JPOSUG perl packages
