...
%define sfe_cpan_name parallel-scoreboard
...
License:               perl_5
URL:                   https://metacpan.org/pod/Parallel::Scoreboard
Source0:               http://cpan.metacpan.org/authors/id/K/KA/KAZUHO/Parallel-Scoreboard-%{version}.tar.gz
...
BuildRequires:    library/perl-5/sub-uplevel-520
...
- bump to 0.07 and build packages for perl-510, perl-516 and perl-520
