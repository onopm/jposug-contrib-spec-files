...
%define gemname apachelogregex
%define sfe_gemname apachelogregex
...
Summary:          Apache Log Regex is a Ruby port of Peter Hickman's Apache::LogRegex 1.4 Perl module
Name:             SFEruby-%{sfe_gemname}
IPS_package_name: library/ruby/%{gemname}
Version:          0.1.0
License:          MIT
URL:              http://code.simonecarletti.com/apachelogregex
...
Requires:         runtime/ruby-21 = *
# echoe >= 3.1
Requires:         library/ruby/echoe-21
...
Requires:         runtime/ruby-22 = *
# echoe >= 3.1
Requires:         library/ruby/echoe-22
# Requires:         library/ruby/%{gemname}
...
Requires:         runtime/ruby-23 = *
# echoe >= 3.1
Requires:         library/ruby/echoe-23
# Requires:         library/ruby/%{gemname}
...
# echoe >= 3.1
Requires:         jposug/library/ruby/echoe-23jposug
# Requires:         library/ruby/%{gemname}
...
# echoe >= 3.1
Requires:         jposug/library/ruby/echoe-24jposug
# Requires:         library/ruby/%{gemname}
...
# echoe >= 3.1
Requires:         jposug/library/ruby/echoe-25jposug
# Requires:         library/ruby/%{gemname}
...
# echoe >= 3.1
Requires:         jposug/library/ruby/echoe-26jposug
# Requires:         library/ruby/%{gemname}
