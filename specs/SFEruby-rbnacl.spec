...
%define sfe_gemname rbnacl

Summary:          The Networking and Cryptography (NaCl) library provides a high-level toolkit for building cryptographic systems and protocols
...
# ffi >= 0
Requires:         jposug/library/ruby/ffi-23jposug
# Requires:         library/ruby/%{gemname}
...
# ffi >= 0
Requires:         jposug/library/ruby/ffi-24jposug
# Requires:         library/ruby/%{gemname}
...
# ffi >= 0
Requires:         jposug/library/ruby/ffi-25jposug
# Requires:         library/ruby/%{gemname}
...
# ffi >= 0
Requires:         jposug/library/ruby/ffi-26jposug
# Requires:         library/ruby/%{gemname}
