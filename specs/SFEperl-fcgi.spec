...
%define sfe_cpan_name fcgi
%define ips_cpan_name fcgi
...
Source0:               http://cpan.metacpan.org/authors/id/E/ET/ETHER/FCGI-%{version}.tar.gz
...
- bump to 0.78 and add packages for perl-5{22,26{,jposug}}
