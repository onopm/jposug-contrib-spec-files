#
# spec file for package PostgreSQL 9.4
#
...
Source3:		 postgres-94-auth_attr
Source4:		 postgres-94-prof_attr
Source5:		 postgres-94-exec_attr
Source6:		 postgres-94-user_attr
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libecpg.so.6.6
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libecpg_compat.so.3.6
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpgtypes.so.3.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so.5.7
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg.so.6.6
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg_compat.so.3.6
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgtypes.so.3.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5.7
...
%{_prefix}/%{major_version}/lib/test_shm_mq.so
...
%{_prefix}/%{major_version}/lib/amd64/test_shm_mq.so
...
%{_prefix}/%{major_version}/share/extension/pageinspect--1.2.sql
...
%{_prefix}/%{major_version}/share/extension/pg_stat_statements--1.2.sql
...
%{_prefix}/%{major_version}/share/extension/pgcrypto--1.1.sql
...
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.2.sql
