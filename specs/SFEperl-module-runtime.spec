...
%define sfe_cpan_name module-runtime
%define ips_cpan_name module-runtime
...
Source0:               http://cpan.metacpan.org/authors/id/Z/ZE/ZEFRAM/Module-Runtime-%{version}.tar.gz
...
- bump to 0.016 and add packages for perl-{522,526,526jposug}
* Thu Nov 12 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 0.014 and build packages for perl-510, perl-516 and perl-520
