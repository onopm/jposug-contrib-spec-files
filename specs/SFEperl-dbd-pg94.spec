...
%define sfe_cpan_name dbd-pg94
%define ips_cpan_name dbd-pg94
...
build_for() {
  ...
  then
     POSTGRES_LIB="/usr/postgres/9.4/lib/%{_arch64}/"; export POSTGRES_LIB
  else
     POSTGRES_LIB="/usr/postgres/9.4/lib/"; export POSTGRES_LIB
  fi
  if [ -f Build.PL ];
  then
    build_with_build.pl_for $*
