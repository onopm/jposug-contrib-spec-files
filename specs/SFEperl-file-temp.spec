...
%define ips_cpan_name file-temp

Summary:               return name and handle of a temporary file safely
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      jposug/library/perl-5/%{ips_cpan_name}
Version:               0.2309
IPS_component_version: 0.2309
License:               perl_5
URL:                   https://metacpan.org/pod/File::Temp
Source0:               http://cpan.metacpan.org/authors/id/E/ET/ETHER/File-Temp-%{version}.tar.gz
...
- bump to 0.2309 and build only for JPOSUG Perl packages
