...
%define cpan_name Digest
%define sfe_cpan_name digest
...
License:               perl_5
URL:                   https://metacpan.org/pod/Digest
Source0:               http://cpan.metacpan.org/authors/id/G/GA/GAAS/Digest-%{version}.tar.gz
...
%if %{build584}
%package 584-old
IPS_package_name: library/perl-5/%{sfe_cpan_name}-base-584
Summary:          Modules that calculate message digests
BuildRequires:    runtime/perl-584 = *
Requires:         runtime/perl-584 = *
Requires:         library/perl-5/%{sfe_cpan_name}-584
...
%if %{build512}
%package 512-old
IPS_package_name: library/perl-5/%{sfe_cpan_name}-base-512
Summary:          Modules that calculate message digests
BuildRequires:    runtime/perl-512 = *
Requires:         runtime/perl-512 = *
Requires:         library/perl-5/%{sfe_cpan_name}-512
