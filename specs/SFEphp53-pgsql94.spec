#
# spec file for package SFEphp53-pgsql94
#
...
%define _prefix /usr
%define tarball_version  5.3.29
%define tarball_name     php

Name:                    SFEphp53-pgsql94
IPS_package_name:        web/php-53/extension/php-pgsql94
Summary:                 PHP 5.3 module for PostgreSQL 94
...
BuildRequires: database/postgres-94/library
BuildRequires: database/postgres-94/developer
BuildRequires: SFEre2c

Requires: database/postgres-94/library
Requires: web/php-53

%description
The SFEphp53-pgsql94 package includes a dynamic shared object (DSO) that can
be compiled in to the Apache Web server to add PostgreSQL-9.4 database
support to PHP. PostgreSQL-9.4 is an object-relational database management
system that supports almost all SQL constructs. PHP is an
HTML-embedded scripting language. If you need back-end support for
PostgreSQL-9.4, you should install this package in addition to the main
php package.
...
./configure \
 ...
 --includedir=%{_includedir} \
 --with-php-config=/usr/php/5.3/bin/php-config \
 --with-pdo-pgsql=/usr/postgres/9.4
gmake -j$CPUS
popd
