...
%define sfe_cpan_name proc-proctbl
%define ips_cpan_name proc-processtable
...
License:               perl_5
URL:                   https://metacpan.org/pod/Proc::ProcessTable
Source0:               http://cpan.metacpan.org/authors/id/J/JW/JWB/Proc-ProcessTable-%{version}.tar.gz
...
- bump to 0.56 and add packages for perl-{522,526,526jposug}
* Wed Nov 11 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 0.53 and build packages for perl-510, perl-516 and perl-520
