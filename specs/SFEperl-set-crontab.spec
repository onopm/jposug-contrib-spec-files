...
%define cpan_name Set-Crontab
%define sfe_cpan_name set-crontab
%define ips_cpan_name set-crontab
...
Source0:               http://cpan.metacpan.org/authors/id/A/AM/AMS/Set-Crontab-%{version}.tar.gz
