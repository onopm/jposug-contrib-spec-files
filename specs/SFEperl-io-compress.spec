...
%define sfe_cpan_name io-compress
%define ips_cpan_name io-compress
...
License:               perl_5
URL:                   https://metacpan.org/pod/IO::Compress
Source0:               http://cpan.metacpan.org/authors/id/P/PM/PMQS/IO-Compress-%{version}.tar.gz
...
Requires:         library/perl-5/%{ips_cpan_name}
%if %{enable_test}
BuildRequires:    library/perl-5/compress-raw-bzip2-516
...
%if %{enable_test}
BuildRequires:    library/perl-5/compress-raw-bzip2-526
...
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/compress-raw-bzip2-526
...
%if %{enable_test}
BuildRequires:    library/perl-5/compress-raw-bzip2-526jposug
...
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/compress-raw-bzip2-526jposug
...
- bump to 2.081 and add packages for perl-5{22,26{,jposug}}
