...
BuildRequires:    jposug/library/perl-5/test-pod-530jposug
BuildRequires:    jposug/library/perl-5/test-pod-coverage-530jposug
%endif
Requires:         runtime/perl-530jposug = *
# Requires:         jposug/library/perl-5/%{ips_cpan_name}
Requires:         jposug/library/perl-5/carp-530jposug
Requires:         jposug/library/perl-5/test-pod-530jposug
Requires:         jposug/library/perl-5/test-pod-coverage-530jposug
...
- bump to 5.74 and build only for JPOSUG Perl packages
