...
%define sfe_cpan_name f-sharedir-inst
%define ips_cpan_name file-sharedir-install
...
Source0:               http://cpan.metacpan.org/authors/id/E/ET/ETHER/File-ShareDir-Install-%{version}.tar.gz
...
- bump to 0.13 and add packages for perl-5{22,26{,jposug}}
* Thu Nov 12 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 0.10 and build packages for perl-510, perl-516 and perl-520
