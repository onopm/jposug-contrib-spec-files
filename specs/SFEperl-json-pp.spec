...
%define sfe_cpan_name json-pp
%define ips_cpan_name json-pp

Summary:               JSON::XS compatible pure-Perl module.
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      jposug/library/perl-5/%{ips_cpan_name}
Version:               4.04
IPS_component_version: 4.4
License:               perl_5
URL:                   https://metacpan.org/pod/JSON::PP
Source0:               http://cpan.metacpan.org/authors/id/I/IS/ISHIGAKI/JSON-PP-%{version}.tar.gz
...
- bump 4.04 and build only for JPOSUG Perl packages
* Wed May 23 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 2.97001 and add packages for perl-526{,jposug}
* Mon Jun 05 2017 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 2.94
* Wed Nov 04 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 2.27300 and build packages for perl-516 and perl-520
