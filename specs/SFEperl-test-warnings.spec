...
%define sfe_cpan_name test-warnings
%define ips_cpan_name test-warnings
...
Source0:               http://cpan.metacpan.org/authors/id/E/ET/ETHER/Test-Warnings-%{version}.tar.gz
...
- bump to 0.026 and add packages for perl-5{22,26{,jposug}}
