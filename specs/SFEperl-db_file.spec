...
%define sfe_cpan_name db-file
%define ips_cpan_name db_file

Summary:               Perl5 access to Berkeley DB version 1.x
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               1.841
IPS_component_version: 1.841
License:               perl_5
URL:                   https://metacpan.org/pod/DB_File
Source0:               http://cpan.metacpan.org/authors/id/P/PM/PMQS/DB_File-%{version}.tar.gz
...
- bump to 1.841 and add packages for perl-526{,jposug}
