...
%define sfe_cpan_name test-wo-mod
%define ips_cpan_name test-without-module
...
Source0:               http://cpan.metacpan.org/authors/id/C/CO/CORION/Test-Without-Module-%{version}.tar.gz
