...
%define sfe_cpan_name http-body
%define ips_cpan_name http-body
...
License:               perl_5
URL:                   https://metacpan.org/pod/HTTP::Body
Source0:               http://cpan.metacpan.org/authors/id/G/GE/GETTY/HTTP-Body-%{version}.tar.gz
...
- bump to 1.22 and build packages for perl-510, perl-516 and perl-520
