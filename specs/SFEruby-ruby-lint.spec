...
# slop >= 3.4.7, ~> 3.4
Requires:         jposug/library/ruby/slop-23jposug
...
# slop >= 3.4.7, ~> 3.4
Requires:         jposug/library/ruby/slop-24jposug
Requires:         jposug/library/ruby/%{gemname}
...
# slop >= 3.4.7, ~> 3.4
Requires:         jposug/library/ruby/slop-25jposug
Requires:         jposug/library/ruby/%{gemname}
...
- bump to 2.3.1 and build packages for ruby-2{3,4,5}jposug
