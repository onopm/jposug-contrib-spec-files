...
%define sfe_gemname growthforecast

Summary:          Client library and tool to update values, create/edit/delete graphs of GrowthForecast
Name:             SFEruby-%{sfe_gemname}
IPS_package_name: library/ruby/%{gemname}
Version:          0.0.5
License:          Apache License, Version 2.0
URL:              https://github.com/tagomoris/rb-growthforecast
...
# resolve-hostname >= 0
Requires:         library/ruby/resolve-hostname-19
...
# resolve-hostname >= 0
Requires:         library/ruby/resolve-hostname-20
...
# resolve-hostname >= 0
Requires:         library/ruby/resolve-hostname-21
...
# resolve-hostname >= 0
Requires:         library/ruby/resolve-hostname-22
...
# resolve-hostname >= 0
Requires:         library/ruby/resolve-hostname-23
...
- bump to 0.0.5 and build package for ruby-23
