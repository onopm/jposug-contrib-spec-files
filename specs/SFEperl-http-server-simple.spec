...
%define sfe_cpan_name http-server-simple
%define ips_cpan_name http-server-simple
...
Source0:               http://cpan.metacpan.org/authors/id/B/BP/BPS/HTTP-Server-Simple-%{version}.tar.gz
