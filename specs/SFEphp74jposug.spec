...
%define tarball_version  7.4.2
%define major_version    7.4
%define prefix_name      SFEphp74jposug
%define _basedir         %{_prefix}/%{major_version}
%define zts              20180731

Name:                    %{prefix_name}
IPS_package_name:        jposug/web/php-74jposug
Summary:                 php
Version:                 %{tarball_version}
License:                 PHP
Url:                     http://php.net/
Source:                  http://jp2.php.net/distributions/%{tarball_name}-%{tarball_version}.tar.xz
Source1:                 php-fpm74jposug.xml
...
BuildRequires: jposug/library/oniguruma
...
Requires:       jposug/library/oniguruma
...
install -m 644 %{SOURCE1} $RPM_BUILD_ROOT/var/svc/manifest/network/php-fpm74jposug.xml
