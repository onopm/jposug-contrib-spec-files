...
%define sfe_cpan_name crypt-rijndael
%define ips_cpan_name crypt-rijndael
...
Source0:               http://cpan.metacpan.org/authors/id/L/LE/LEONT/Crypt-Rijndael-%{version}.tar.gz
