...
%define sfe_cpan_name file-find-rule-perl
%define ips_cpan_name file-find-rule-perl
...
Source0:               http://cpan.metacpan.org/authors/id/E/ET/ETHER/File-Find-Rule-Perl-%{version}.tar.gz
