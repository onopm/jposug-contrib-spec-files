#
# spec file for package PostgreSQL 9.5
#
...
Source1:		 postgres-95-postgres_95
Source2:		 postgres-95-postgresql_95.xml
Source3:		 postgres-95-auth_attr
Source4:		 postgres-95-prof_attr
Source5:		 postgres-95-exec_attr
Source6:		 postgres-95-user_attr
...
IPS_package_name: database/postgres-95/library
Summary: PostgreSQL client libraries
Requires: %{pnm_requires_SUNWlibms}
Requires: %{pnm_requires_SUNWcsl}

%package -n %{prefix_name}-pl
IPS_package_name: database/postgres-95/language-bindings
...
IPS_package_name: database/postgres-95/developer
...
IPS_package_name: database/postgres-95/documentation
Summary: PostgreSQL documentation and man pages

%package -n %{prefix_name}-server
IPS_package_name: service/database/postgres-95
...
IPS_package_name: database/postgres-95/contrib
...
cp %{SOURCE1} $RPM_BUILD_ROOT/lib/svc/method/postgres_95
chmod +x $RPM_BUILD_ROOT/lib/svc/method/postgres_95
mkdir -p $RPM_BUILD_ROOT/var/svc/manifest/application/database/
cp %{SOURCE2} $RPM_BUILD_ROOT/var/svc/manifest/application/database/postgresql_95.xml

# attribute
mkdir -p $RPM_BUILD_ROOT/etc/security/auth_attr.d/
cp %{SOURCE3} $RPM_BUILD_ROOT/etc/security/auth_attr.d/service\%2Fdatabase\%2Fpostgres-95
mkdir -p $RPM_BUILD_ROOT/etc/security/exec_attr.d/
cp %{SOURCE4} $RPM_BUILD_ROOT/etc/security/exec_attr.d/service\%2Fdatabase\%2Fpostgres-95
mkdir -p $RPM_BUILD_ROOT/etc/security/prof_attr.d/
cp %{SOURCE5} $RPM_BUILD_ROOT/etc/security/prof_attr.d/service\%2Fdatabase\%2Fpostgres-95
mkdir -p $RPM_BUILD_ROOT/etc/user_attr.d/
cp %{SOURCE5} $RPM_BUILD_ROOT/etc/user_attr.d/service\%2Fdatabase\%2Fpostgres-95
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg.so.6.7
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg_compat.so.3.7
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgtypes.so.3.6
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5.8
...
%attr (0555, root, bin) /lib/svc/method/postgres_95
%attr (0644, root, sys) /etc/security/auth_attr.d/service\%2Fdatabase\%2Fpostgres-95
%attr (0644, root, sys) /etc/security/exec_attr.d/service\%2Fdatabase\%2Fpostgres-95
%attr (0644, root, sys) /etc/security/prof_attr.d/service\%2Fdatabase\%2Fpostgres-95
...
%{_prefix}/%{major_version}/share/extension/btree_gist--1.1.sql
...
%{_prefix}/%{major_version}/share/extension/dblink--1.1.sql
...
%{_prefix}/%{major_version}/share/extension/hstore--1.3.sql
...
%{_prefix}/%{major_version}/share/extension/pageinspect--1.3.sql
...
%{_prefix}/%{major_version}/share/extension/pg_buffercache--1.1.sql
...
%{_prefix}/%{major_version}/share/extension/pg_stat_statements--1.3.sql
...
%{_prefix}/%{major_version}/share/extension/pg_trgm--1.1.sql
...
%{_prefix}/%{major_version}/share/extension/pgcrypto--1.2.sql
...
%{_prefix}/%{major_version}/share/extension/pgrowlocks--1.1.sql
...
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.3.sql
...
%{_prefix}/%{major_version}/bin/pg_xlogdump
%{_prefix}/%{major_version}/bin/pgbench
%{_prefix}/%{major_version}/bin/vacuumlo
%{_prefix}/%{major_version}/bin/pg_recvlogical
