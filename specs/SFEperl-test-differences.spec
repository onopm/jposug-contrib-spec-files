...
%define sfe_cpan_name test-differences
%define ips_cpan_name test-differences

Summary:               Test strings and data structures and show differences if not ok
Name:                  perl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               0.64
IPS_component_version: 0.64
License:               unknown
URL:                   https://metacpan.org/pod/Test::Differences
Source0:               http://cpan.metacpan.org/authors/id/D/DC/DCANTRELL/Test-Differences-%{version}.tar.gz
...
Requires:         library/perl-5/text-diff-510
...
Requires:         library/perl-5/text-diff-516
