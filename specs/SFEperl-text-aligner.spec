...
%define sfe_cpan_name text-aligner
%define ips_cpan_name text-aligner
...
License:               mit
URL:                   https://metacpan.org/pod/Text::Aligner
Source0:               http://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/Text-Aligner-%{version}.tar.gz
