...
%define cpan_name base
%define sfe_cpan_name base
%define ips_cpan_name base

Summary:               compile-time class fields
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               2.23
IPS_component_version: 2.23
License:               unknown
URL:                   https://metacpan.org/pod/base
Source0:               http://cpan.metacpan.org/authors/id/R/RJ/RJBS/base-%{version}.tar.gz
