...
%define sfe_cpan_name math-complex
%define ips_cpan_name math-complex

Summary:               trigonometric functions
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               1.59
IPS_component_version: 1.59
License:               perl_5
URL:                   https://metacpan.org/pod/Math::Complex
Source0:               http://cpan.metacpan.org/authors/id/Z/ZE/ZEFRAM/Math-Complex-%{version}.tar.gz
