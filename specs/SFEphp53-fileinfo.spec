...
Name:                    SFEphp53-fileinfo
IPS_package_name:	 web/php-53/extension/php-fileinfo
Summary:                 PHP 5.3 module for Fileinfo
Version:                 1.0.4
License:		 PHP License
...
cp modules/fileinfo.so $RPM_BUILD_ROOT/%{_prefix}/php/5.3/modules/
mkdir -p  $RPM_BUILD_ROOT/etc/php/5.3/conf.d
cp %{SOURCE1} $RPM_BUILD_ROOT/etc/php/5.3/conf.d/%{tarball_name}.ini
