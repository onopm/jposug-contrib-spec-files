...
%if %{enable_test}
BuildRequires:    library/perl-5/devel-symdump-526
BuildRequires:    library/perl-5/pod-parser-526
BuildRequires:    library/perl-5/test-simple-526
%endif
Requires:         runtime/perl-526 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/devel-symdump-526
Requires:         library/perl-5/pod-parser-526
...
%if %{enable_test}
BuildRequires:    library/perl-5/devel-symdump-526jposug
BuildRequires:    library/perl-5/pod-parser-526jposug
BuildRequires:    library/perl-5/test-simple-526jposug
%endif
Requires:         runtime/perl-526jposug = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/devel-symdump-526jposug
