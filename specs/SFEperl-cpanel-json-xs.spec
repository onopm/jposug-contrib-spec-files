...
%define sfe_cpan_name cpanel-json-xs
%define ips_cpan_name cpanel-json-xs

Summary:               cPanel fork of JSON::XS, fast and correct serializing
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               4.02
IPS_component_version: 4.2
License:               perl_5
URL:                   https://metacpan.org/pod/Cpanel::JSON::XS
Source0:               http://cpan.metacpan.org/authors/id/R/RU/RURBAN/Cpanel-JSON-XS-%{version}.tar.gz
