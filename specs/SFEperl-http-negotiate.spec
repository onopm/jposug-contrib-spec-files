...
%define sfe_cpan_name http-negotiate
%define ips_cpan_name http-negotiate
...
Source0:               http://cpan.metacpan.org/authors/id/G/GA/GAAS/HTTP-Negotiate-%{version}.tar.gz
...
- build packages for 5.16 and higher
