...
%define sfe_cpan_name class-accessor-lite
%define ips_cpan_name class-accessor-lite
...
Source0:               http://cpan.metacpan.org/authors/id/K/KA/KAZUHO/Class-Accessor-Lite-%{version}.tar.gz
...
- bump to 0.08 and build packages for perl-510, perl-516 and perl-520
