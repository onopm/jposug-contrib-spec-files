...
%define cpan_name Text-ParseWords
%define sfe_cpan_name text-parsewords
%define ips_cpan_name text-parsewords
...
License:               perl_5
URL:                   https://metacpan.org/pod/Text::ParseWords
Source0:               http://cpan.metacpan.org/authors/id/C/CH/CHORNY/Text-ParseWords-%{version}.tar.gz
