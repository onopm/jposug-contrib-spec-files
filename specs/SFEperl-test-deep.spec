...
%define sfe_cpan_name test-deep
%define ips_cpan_name test-deep
...
Source0:               http://cpan.metacpan.org/authors/id/R/RJ/RJBS/Test-Deep-%{version}.tar.gz
...
- bump to 1.128 and add packges for perl-526{,jposug}
* Thu Apr 27 2017 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.126, package for perl-522 is added, for perl-520 is obsolete
