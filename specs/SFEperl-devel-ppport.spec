...
%define sfe_cpan_name devel-ppport
%define ips_cpan_name devel-ppport
...
License:               perl_5
URL:                   https://metacpan.org/pod/Devel::PPPort
Source0:               http://cpan.metacpan.org/authors/id/W/WO/WOLFSAGE/Devel-PPPort-%{version}.tar.gz
...
- bump to 3.36 and build packages for perl-522 and perl-526
