...
%define sfe_cpan_name exporter-tiny
%define ips_cpan_name exporter-tiny

Summary:               an exporter with the features of Sub::Exporter but only core dependencies
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               0.042
IPS_component_version: 0.42
License:               perl_5
URL:                   https://metacpan.org/pod/Exporter::Tiny
Source0:               http://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Exporter-Tiny-%{version}.tar.gz
