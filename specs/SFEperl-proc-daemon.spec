...
%define sfe_cpan_name proc-daemon
%define ips_cpan_name proc-daemon
...
Source0:               http://cpan.metacpan.org/authors/id/A/AK/AKREAL/Proc-Daemon-%{version}.tar.gz
...
BuildRequires:    library/perl-5/proc-processtable-584
%if %{enable_test}
%endif
...
BuildRequires:    library/perl-5/proc-processtable-510
%if %{enable_test}
%endif
...
BuildRequires:    library/perl-5/proc-processtable-512
%if %{enable_test}
%endif
...
BuildRequires:    library/perl-5/proc-processtable-516
# Requires:         library/perl-5/%{ips_cpan_name}
%if %{enable_test}
%endif
...
BuildRequires:    library/perl-5/proc-processtable-522
%if %{enable_test}
%endif
...
BuildRequires:    library/perl-5/proc-processtable-526
%if %{enable_test}
%endif
...
BuildRequires:    library/perl-5/proc-processtable-526jposug
%if %{enable_test}
%endif
...
- bump to 0.23 and add packages for perl-{522,526,526jpousg}
