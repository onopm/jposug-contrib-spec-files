#
# spec file for package SFEruby-mysql-29-51
# gem install mysql (2.9.x)
#
%include Solaris.inc
...
Name: SFEruby-%{gemname}-29-51
IPS_package_name:        library/ruby/mysql-29/mysql-51
SUNW_Copyright:   %name.copyright
Version: 2.9.1
License: GPL
URL: http://rubygems.org/gems/%{gemname}
Source0: http://rubygems.org/downloads/%{gemname}-%{version}.gem
Patch0: %{name}-2.9.1.patch
...
%if %with_ruby18
%package 18
IPS_package_name: library/ruby-18/mysql-29/mysql-51
Summary: A simple, fast Mysql library for Ruby, binding to libmysql
BuildRequires:  runtime/ruby-18
Requires:       runtime/ruby-18
Requires:       %pnm_requires_mysql51lib
Requires:	library/ruby/mysql-29/mysql-51
...
%package 19
IPS_package_name: library/ruby-19/mysql-29/mysql-51
Summary: A simple, fast Mysql library for Ruby, binding to libmysql
...
%if %with_ruby20
#%package 20
#IPS_package_name: library/ruby-20/mysql-29/mysql-51
#Summary: A simple, fast Mysql library for Ruby, binding to libmysql
