...
%define cpan_name Text-Abbrev
%define sfe_cpan_name text-abbrev
%define ips_cpan_name text-abbrev
...
License:               perl_5
URL:                   https://metacpan.org/pod/Text::Abbrev
Source0:               http://cpan.metacpan.org/authors/id/F/FL/FLORA/Text-Abbrev-%{version}.tar.gz
