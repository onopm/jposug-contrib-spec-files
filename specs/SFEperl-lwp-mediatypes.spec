...
%define sfe_cpan_name lwp-mediatypes
%define ips_cpan_name lwp-mediatypes
...
Source0:               http://cpan.metacpan.org/authors/id/G/GA/GAAS/LWP-MediaTypes-%{version}.tar.gz
