...
%define sfe_cpan_name parent
%define ips_cpan_name parent

Summary:               Establish an ISA relationship with base classes at compile time
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      jposug/library/perl-5/%{ips_cpan_name}
Version:               0.238
IPS_component_version: 0.238
License:               perl_5
URL:                   https://metacpan.org/pod/parent
Source0:               http://cpan.metacpan.org/authors/id/C/CO/CORION/parent-%{version}.tar.gz
...
- bump to 0.238 and build only for JPOSUG Perl packages
* Tue May 22 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- add package for perl-526{,jposug}
...
- bump to 0.234 and build packages for perl-516 and perl-520
