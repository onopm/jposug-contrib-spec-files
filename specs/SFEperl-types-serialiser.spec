...
%define sfe_cpan_name types-serialiser
%define ips_cpan_name types-serialiser
...
Source0:               http://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/Types-Serialiser-%{version}.tar.gz
