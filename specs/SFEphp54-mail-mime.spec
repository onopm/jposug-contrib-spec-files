...
%define pear_dir   %(/usr/php/5.4/bin/pear config-get php_dir)

Name:                    SFEphp54-mail-mime
IPS_package_name:	 web/php-54/extension/php-mail-mime
Summary:                 PHP 5.4 module for MAIL_Mime
Version:                 1.8.6
License:		 BSD Style
...
rm -rf %{buildroot}
/usr/php/5.4/bin/pear -c pearrc install --nodeps --packagingroot %{buildroot} %{SOURCE0}
...
%changelog
* Thu Aug 01 JST 2013 Fumihisa TONAKA <fumi.ftnk@gmail.com>
- initial commit
