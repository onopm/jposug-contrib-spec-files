#
# spec file for package: SFEperl-http-body
#
...
%define tarball_name    HTTP-Body

Name:		SFEperl-http-body
IPS_package_name: library/perl-5/http-body
Version:	1.15
...
Source0:	http://search.cpan.org/CPAN/authors/id/G/GE/GETTY/HTTP-Body-%{tarball_version}.tar.gz
...
%package 584
IPS_package_name: library/perl-5/http-body-584
Summary: HTTP Body Parser for perl-584
BuildRequires:	runtime/perl-584
...
%package 512
IPS_package_name: library/perl-5/http-body-512
Summary: HTTP Body Parser for perl-512
BuildRequires:	runtime/perl-512
