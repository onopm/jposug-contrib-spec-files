...
Renamed_To:         web/php/extension/php-http-request2-56 = *
%endif

%if %{build71}
%package 71
IPS_package_name:   web/php/extension/php-http-request2-71
...
%if %{build72}
%package 72
IPS_package_name:   web/php/extension/php-http-request2-72
...
%if %{build71jposug}
%package 71jposug
IPS_package_name:   web/php/extension/php-http-request2-71jposug
...
%if %{build72jposug}
%package 72jposug
IPS_package_name:   web/php/extension/php-http-request2-72jposug
...
%{pear_dir_53}/*
%{pear_dir_53}/.registry/http_request2.reg
%endif
...
%{pear_dir_55}/*
%{pear_dir_55}/.registry/http_request2.reg
%endif
...
%{pear_dir_56}/*
%{pear_dir_56}/.registry/http_request2.reg
%endif
...
%{pear_dir_71}/*
%{pear_dir_71}/.registry/http_request2.reg
%endif
...
%{pear_dir_72}/*
%{pear_dir_72}/.registry/http_request2.reg
%endif
...
%{pear_dir_71jposug}/*
%{pear_dir_71jposug}/.registry/http_request2.reg
%endif
...
%{pear_dir_72jposug}/*
%{pear_dir_72jposug}/.registry/http_request2.reg
%endif
