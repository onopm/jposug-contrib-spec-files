...
%define sfe_cpan_name http-headers-fast
%define ips_cpan_name http-headers-fast
...
License:               perl_5
URL:                   https://metacpan.org/pod/HTTP::Headers::Fast
Source0:               http://cpan.metacpan.org/authors/id/T/TO/TOKUHIROM/HTTP-Headers-Fast-%{version}.tar.gz
...
- bump to 0.19 and build packages for perl-510, perl-516 and perl-520
