...
Summary: a (hopefully) high quality http parser library
Name: SFEruby-http-parser
IPS_package_name:        library/ruby-18/http_parser
Version: 0.1.3
License: MIT License
...
%package 19
IPS_package_name: library/ruby-19/http_parser
Summary: %{gemname}
