...
Source0:               http://cpan.metacpan.org/authors/id/M/MA/MAKAMAKA/JSON-PP-%{version}.tar.gz
...
# perl-516 and perl-520 have /usr/perl5/${version}/bin/json_pp
rm -rf $RPM_BUILD_ROOT/usr/perl5/5.16
rm -rf $RPM_BUILD_ROOT/usr/perl5/5.20
