...
BuildRequires:    jposug/library/perl-5/net-ssleay-530jposug
%if %{enable_test}
BuildRequires:    jposug/library/perl-5/mozilla-ca-530jposug
BuildRequires:    jposug/library/perl-5/net-ssleay-530jposug
...
Requires:         jposug/library/perl-5/mozilla-ca-530jposug
Requires:         jposug/library/perl-5/net-ssleay-530jposug
...
- bump to 2.067 and only build for JPOSUG perl packages
