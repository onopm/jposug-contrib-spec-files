...
%define sfe_cpan_name file-sharedir
%define ips_cpan_name file-sharedir

Summary:               Locate per-dist and per-module shared files
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               1.104
IPS_component_version: 1.104
License:               perl_5
URL:                   https://metacpan.org/pod/File::ShareDir
Source0:               http://cpan.metacpan.org/authors/id/R/RE/REHSACK/File-ShareDir-%{version}.tar.gz
...
BuildRequires:    library/perl-5/inc-latest-584
BuildRequires:    library/perl-5/test-simple-584
%if %{enable_test}
BuildRequires:    library/perl-5/carp-584
BuildRequires:    library/perl-5/class-inspector-584
BuildRequires:    library/perl-5/pathtools-584
%endif
Requires:         runtime/perl-584 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/carp-584
Requires:         library/perl-5/class-inspector-584
...
BuildRequires:    library/perl-5/inc-latest-510
BuildRequires:    library/perl-5/test-simple-510
BuildRequires:    library/perl-5/carp-510
BuildRequires:    library/perl-5/class-inspector-510
BuildRequires:    library/perl-5/pathtools-510
Requires:         runtime/perl-510 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/carp-510
Requires:         library/perl-5/class-inspector-510
...
BuildRequires:    library/perl-5/inc-latest-512
BuildRequires:    library/perl-5/test-simple-512
%if %{enable_test}
BuildRequires:    library/perl-5/carp-512
BuildRequires:    library/perl-5/class-inspector-512
...
BuildRequires:    library/perl-5/inc-latest-516
BuildRequires:    library/perl-5/test-simple-516
Requires:         library/perl-5/%{ips_cpan_name}
%if %{enable_test}
BuildRequires:    library/perl-5/carp-516
BuildRequires:    library/perl-5/class-inspector-516
BuildRequires:    library/perl-5/pathtools-516
%endif
Requires:         runtime/perl-516 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/carp-516
Requires:         library/perl-5/class-inspector-516
...
BuildRequires:    library/perl-5/file-sharedir-install-522
BuildRequires:    library/perl-5/inc-latest-522
BuildRequires:    library/perl-5/test-simple-522
%if %{enable_test}
BuildRequires:    library/perl-5/carp-522
BuildRequires:    library/perl-5/class-inspector-522
BuildRequires:    library/perl-5/pathtools-522
%endif
Requires:         runtime/perl-522 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/carp-522
Requires:         library/perl-5/class-inspector-522
...
BuildRequires:    library/perl-5/file-sharedir-install-526
BuildRequires:    library/perl-5/inc-latest-526
BuildRequires:    library/perl-5/test-simple-526
%if %{enable_test}
BuildRequires:    library/perl-5/carp-526
BuildRequires:    library/perl-5/class-inspector-526
BuildRequires:    library/perl-5/pathtools-526
%endif
Requires:         runtime/perl-526 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/carp-526
Requires:         library/perl-5/class-inspector-526
...
# BuildRequires:    library/perl-5/file-sharedir-install-526jposug
# BuildRequires:    library/perl-5/inc-latest-526jposug
BuildRequires:    library/perl-5/test-simple-526jposug
%if %{enable_test}
BuildRequires:    library/perl-5/carp-526jposug
BuildRequires:    library/perl-5/class-inspector-526jposug
BuildRequires:    library/perl-5/pathtools-526jposug
%endif
Requires:         runtime/perl-526jposug = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/carp-526jposug
Requires:         library/perl-5/class-inspector-526jposug
...
- bump to 1.104 and add packages for perl-{522,526{,jposug}}
* Sun Nov 15 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.102 and build packages for perl-510, perl-516 and perl-520
