...
%define sfe_cpan_name net-ssleay
%define ips_cpan_name net-ssleay

Summary:               Perl extension for using OpenSSL
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      jposug/library/perl-5/%{ips_cpan_name}
Version:               1.88
IPS_component_version: 1.88
License:               artistic_2
URL:                   https://metacpan.org/pod/Net::SSLeay
Source0:               http://cpan.metacpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-%{version}.tar.gz
...
%endif
    ...
    # use `echo 'n' | ` to skip external tests
    echo 'n' | \
