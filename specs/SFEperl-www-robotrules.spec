#
# spec file for package: SFEperl-www-robotrules
#
...
%define tarball_name    WWW-RobotRules

Name:		SFEperl-www-robotrules
IPS_package_name: library/perl-5/www-robotrules
Version:	6.02
...
Source0:	http://search.cpan.org/CPAN/authors/id/G/GA/GAAS/WWW-RobotRules-%{tarball_version}.tar.gz
...
%package 584
IPS_package_name: library/perl-5/www-robotrules-584
Summary: Parse /robots.txt file for perl-584
BuildRequires:	runtime/perl-584
...
%package 512
IPS_package_name: library/perl-5/www-robotrules-512
Summary: Parse /robots.txt file for perl-512
BuildRequires:	runtime/perl-512
