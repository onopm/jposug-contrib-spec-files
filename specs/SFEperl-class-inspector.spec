...
%define sfe_cpan_name class-inspector
%define ips_cpan_name class-inspector
...
Source0:               http://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Class-Inspector-%{version}.tar.gz
...
- bump to 1.32 and add packages for perl-5{22,26{,jposug}}
* Thu Nov 12 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.28 and build packages for perl-510, perl-516 and perl-520
