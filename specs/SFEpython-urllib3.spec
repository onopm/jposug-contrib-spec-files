...
%define tarball_index u
%define tarball_name urllib3
%define tarball_version 1.14
%define include_executable 0

Name:                    SFEpython-urllib3
IPS_package_name:        library/python/urllib3
...
%if %{build26}
%package 26
IPS_package_name: library/python/urllib3-26
Summary:          HTTP library with thread-safe connection pooling, file post, and more.
BuildRequires:    runtime/python-26
Requires:         runtime/python-26
Requires:         library/python/urllib3
...
%if %{build27}
%package 27
IPS_package_name: library/python/urllib3-27
Summary:          HTTP library with thread-safe connection pooling, file post, and more.
...
%if %{build34}
%package 34
IPS_package_name: library/python/urllib3-34
Summary:          HTTP library with thread-safe connection pooling, file post, and more.
...
%if %{build35}
%package 35
IPS_package_name: library/python/urllib3-35
Summary:          HTTP library with thread-safe connection pooling, file post, and more.
