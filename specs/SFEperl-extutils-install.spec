...
%define sfe_cpan_name extutils-install
%define ips_cpan_name extutils-install
...
Source0:               http://cpan.metacpan.org/authors/id/B/BI/BINGOS/ExtUtils-Install-%{version}.tar.gz
...
- bump to 2.14 and build packages for perl-52{2,6,6jposug}
* Tue Nov 10 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 2.04 and build packages for perl-516 and perl-520
