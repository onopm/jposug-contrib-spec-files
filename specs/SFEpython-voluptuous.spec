...
%define tarball_index v
%define tarball_name voluptuous
%define tarball_version 0.9.3
%define include_executable 0

Name:                    SFEpython-voluptuous
IPS_package_name:        library/python/voluptuous
...
%if %{build26}
%package 26
IPS_package_name: library/python/voluptuous-26
Summary:          Voluptuous is a Python data validation library
BuildRequires:    runtime/python-26
Requires:         runtime/python-26
Requires:         library/python/voluptuous
...
%if %{build27}
%package 27
IPS_package_name: library/python/voluptuous-27
Summary:          Voluptuous is a Python data validation library
...
%if %{build34}
%package 34
IPS_package_name: library/python/voluptuous-34
Summary:          Voluptuous is a Python data validation library
...
%if %{build35}
%package 35
IPS_package_name: library/python/voluptuous-35
Summary:          Voluptuous is a Python data validation library
