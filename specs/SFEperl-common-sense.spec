...
%define sfe_cpan_name common-sense
%define ips_cpan_name common-sense

Summary:               save a tree AND a kitten, use common::sense!
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               3.74
IPS_component_version: 3.74
License:               unknown
URL:                   https://metacpan.org/pod/common::sense
Source0:               http://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/common-sense-%{version}.tar.gz
...
- add pacakges for perl-5{22,26{,jposug}}
