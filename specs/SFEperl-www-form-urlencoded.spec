...
%define sfe_cpan_name www-form-urlencoded
%define ips_cpan_name www-form-urlencoded
...
Source0:               http://cpan.metacpan.org/authors/id/K/KA/KAZEBURO/WWW-Form-UrlEncoded-%{version}.tar.gz
...
- bump to 0.22 and build packages for perl-510, perl-516 and perl-520
