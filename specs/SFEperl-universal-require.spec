...
%define sfe_cpan_name universal-require
...
Source0:               http://cpan.metacpan.org/authors/id/N/NE/NEILB/UNIVERSAL-require-%{version}.tar.gz
...
- bump to 0.18 and build packages for perl-510, perl-516 and perl-520
