...
%define cpan_name Module-Load
%define sfe_cpan_name module-load
%define ips_cpan_name module-load
...
Source0:               http://cpan.metacpan.org/authors/id/B/BI/BINGOS/Module-Load-%{version}.tar.gz
...
- bump to 0.34 and only build for JPOSUG perl packages
