#
# spec file for package PostgreSQL 9.3
#
...
Source2:		 postgres-93-postgresql_93.xml
Source3:		 postgres-93-auth_attr
Source4:		 postgres-93-prof_attr
...
IPS_package_name: database/postgres-93/library
Summary: PostgreSQL client libraries
Requires: %{pnm_requires_SUNWlibms}
Requires: %{pnm_requires_SUNWcsl}

%package -n %{prefix_name}-pl
IPS_package_name: database/postgres-93/language-bindings
...
IPS_package_name: database/postgres-93/developer
...
IPS_package_name: database/postgres-93/documentation
Summary: PostgreSQL documentation and man pages

%package -n %{prefix_name}-server
IPS_package_name: service/database/postgres-93
...
cp %{SOURCE1} $RPM_BUILD_ROOT/lib/svc/method/postgres_93
chmod +x $RPM_BUILD_ROOT/lib/svc/method/postgres_93
mkdir -p $RPM_BUILD_ROOT/var/svc/manifest/application/database/
cp %{SOURCE2} $RPM_BUILD_ROOT/var/svc/manifest/application/database/postgresql_93.xml

# attribute
mkdir -p $RPM_BUILD_ROOT/etc/security/auth_attr.d/
cp %{SOURCE3} $RPM_BUILD_ROOT/etc/security/auth_attr.d/service\%2Fdatabase\%2Fpostgres-93
mkdir -p $RPM_BUILD_ROOT/etc/security/exec_attr.d/
cp %{SOURCE4} $RPM_BUILD_ROOT/etc/security/exec_attr.d/service\%2Fdatabase\%2Fpostgres-93
mkdir -p $RPM_BUILD_ROOT/etc/security/prof_attr.d/
cp %{SOURCE5} $RPM_BUILD_ROOT/etc/security/prof_attr.d/service\%2Fdatabase\%2Fpostgres-93
mkdir -p $RPM_BUILD_ROOT/etc/user_attr.d/
cp %{SOURCE5} $RPM_BUILD_ROOT/etc/user_attr.d/service\%2Fdatabase\%2Fpostgres-93
...
# plpython is out in postgresql 9.3
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libecpg.so.6.5
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libecpg_compat.so.3.5
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpgtypes.so.3.4
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so.5.6
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg.so.6.5
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg_compat.so.3.5
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgtypes.so.3.4
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5.6
...
%attr (0644, root, bin) %{_prefix}/%{major_version}/lib/amd64/worker_spi.so
...
%attr (0555, root, bin) /lib/svc/method/postgres_93
%attr (0644, root, sys) /etc/security/auth_attr.d/service\%2Fdatabase\%2Fpostgres-93
%attr (0644, root, sys) /etc/security/exec_attr.d/service\%2Fdatabase\%2Fpostgres-93
%attr (0644, root, sys) /etc/security/prof_attr.d/service\%2Fdatabase\%2Fpostgres-93
%attr (0644, root, sys) /etc/user_attr.d/service\%2Fdatabase\%2Fpostgres-93
%class(manifest) %attr (0444, root, sys) /var/svc/manifest/application/database/postgresql_93.xml
...
%{_prefix}/%{major_version}/share/extension/pageinspect--1.1.sql
...
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.1.sql
