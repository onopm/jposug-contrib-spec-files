...
%define cpan_name libnet
%define sfe_cpan_name libnet
%define ips_cpan_name libnet

Summary:               Collection of network protocol modules
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      jposug/library/perl-5/%{ips_cpan_name}
Version:               3.11
IPS_component_version: 3.11
License:               perl_5
URL:                   https://metacpan.org/pod/libnet
Source0:               http://cpan.metacpan.org/authors/id/S/SH/SHAY/libnet-%{version}.tar.gz
...
Requires:         library/perl-5/socket-526jposug
