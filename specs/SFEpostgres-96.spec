#
# spec file for package PostgreSQL 9.6
#
...
Source3:		 postgres-96-auth_attr
Source4:		 postgres-96-prof_attr
Source5:		 postgres-96-exec_attr
Source6:		 postgres-96-user_attr
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libecpg.so.6.8
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libecpg_compat.so.3.8
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libpgtypes.so.3.7
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libpq.so.5.9
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg.so.6.8
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg_compat.so.3.8
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgtypes.so.3.7
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5.9
