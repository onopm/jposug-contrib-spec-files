...
%define sfe_cpan_name template-tkit
%define ips_cpan_name template-toolkit

Summary:               comprehensive template processing system
Name:                  perl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               2.29
IPS_component_version: 2.29
License:               perl_5
URL:                   https://metacpan.org/pod/Template::Toolkit
Source0:               http://cpan.metacpan.org/authors/id/A/AT/ATOOMIC/Template-Toolkit-%{version}.tar.gz
...
BuildRequires:    library/perl-5/appconfig-584
...
Requires:         library/perl-5/appconfig-584
...
BuildRequires:    library/perl-5/appconfig-510
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/appconfig-510
...
BuildRequires:    library/perl-5/appconfig-512
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/appconfig-512
...
BuildRequires:    library/perl-5/appconfig-516
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/appconfig-516
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/appconfig-522
...
BuildRequires:    library/perl-5/cgi-526
BuildRequires:    library/perl-5/extutils-makemaker-526
%if %{enable_test}
BuildRequires:    library/perl-5/test-leaktrace-526
BuildRequires:    library/perl-5/appconfig-526
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/appconfig-526
...
BuildRequires:    library/perl-5/cgi-526jposug
BuildRequires:    library/perl-5/extutils-makemaker-526jposug
%if %{enable_test}
BuildRequires:    library/perl-5/test-leaktrace-526jposug
BuildRequires:    library/perl-5/appconfig-526jposug
...
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/appconfig-526jposug
...
- bump to 2.29 and add package for perl-{522,526,526jposug}
