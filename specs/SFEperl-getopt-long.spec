...
%define cpan_name Getopt-Long
%define sfe_cpan_name getopt-long
%define ips_cpan_name getopt-long

Summary:               Module to handle parsing command line options
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               2.50
IPS_component_version: 2.50
License:               unknown
URL:                   https://metacpan.org/pod/Getopt::Long
Source0:               http://cpan.metacpan.org/authors/id/J/JV/JV/Getopt-Long-%{version}.tar.gz
...
- bump to 2.50 and add packages for perl-5{22,26{,jposug}}
* Thu Nov 12 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 2.48 and build packages for perl-510, perl-516 and perl-520
