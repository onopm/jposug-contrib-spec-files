...
%define sfe_cpan_name html-template
%define ips_cpan_name html-template
...
Source0:               http://cpan.metacpan.org/authors/id/S/SA/SAMTREGAR/HTML-Template-%{version}.tar.gz
...
- bump to 2.97 and build packages for perl-5{22,26{,jposug}}
* Wed Nov 11 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 2.95 and build packages for perl-516 and perl-520
