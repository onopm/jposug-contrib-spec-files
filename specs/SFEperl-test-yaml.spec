...
%define sfe_cpan_name test-yaml
%define ips_cpan_name test-yaml
...
License:               perl_5
URL:                   https://metacpan.org/pod/Test::YAML
Source0:               http://cpan.metacpan.org/authors/id/T/TI/TINITA/Test-YAML-%{version}.tar.gz
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-base-584
%endif
Requires:         runtime/perl-584 = *
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/test-base-584
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-base-510
%endif
Requires:         runtime/perl-510 = *
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/test-base-510
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-base-512
%endif
Requires:         runtime/perl-512 = *
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/test-base-512
...
# Requires:         library/perl-5/%{ips_cpan_name}
%if %{enable_test}
BuildRequires:    library/perl-5/test-base-516
%endif
Requires:         runtime/perl-516 = *
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/test-base-516
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-base-522
%endif
Requires:         runtime/perl-522 = *
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/test-base-522
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-base-526
%endif
Requires:         runtime/perl-526 = *
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/test-base-526
...
%if %{enable_test}
BuildRequires:    library/perl-5/test-base-526jposug
%endif
Requires:         runtime/perl-526jposug = *
# Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/test-base-526jposug
...
%changelog
* Fri May 17 2019 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.07 and add packages for perl-{510,522,526,562jposug}
