...
%define cpan_name Router-Boom
%define sfe_cpan_name router-boom
%define ips_cpan_name router-boom
...
License:               perl_5
URL:                   https://metacpan.org/pod/Router::Boom
Source0:               http://cpan.metacpan.org/authors/id/T/TO/TOKUHIROM/Router-Boom-%{version}.tar.gz
...
- bump to 1.02 and build packages for perl-510, perl-516 and perl-520
