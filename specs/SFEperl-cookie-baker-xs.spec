...
%define cpan_name Cookie-Baker-XS
%define sfe_cpan_name cookie-baker-xs
%define ips_cpan_name cookie-baker-xs
...
License:               perl_5
URL:                   https://metacpan.org/pod/Cookie::Baker::XS
Source0:               http://cpan.metacpan.org/authors/id/K/KA/KAZEBURO/Cookie-Baker-XS-%{version}.tar.gz
BuildRoot:             %{_tmppath}/%{name}-%{version}-build

%description
boost Cookie::Baker's crush_cookie
