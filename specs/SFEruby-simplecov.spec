...
Requires:         runtime/ruby-21 = *
# docile ~> 1.1.0
Requires:         library/ruby/docile-21
# json < 3, >= 1.8
Requires:         library/ruby/json-21
# simplecov-html ~> 0.10.0
Requires:         library/ruby/simplecov-html-21
...
Requires:         runtime/ruby-22 = *
# docile ~> 1.1.0
Requires:         library/ruby/docile-22
# json < 3, >= 1.8
Requires:         library/ruby/json-22
# simplecov-html ~> 0.10.0
Requires:         library/ruby/simplecov-html-22
# Requires:         library/ruby/%{gemname}
...
Requires:         runtime/ruby-23 = *
# docile ~> 1.1.0
Requires:         library/ruby/docile-23
# json < 3, >= 1.8
Requires:         library/ruby/json-23
# simplecov-html ~> 0.10.0
Requires:         library/ruby/simplecov-html-23
# Requires:         library/ruby/%{gemname}
...
# docile ~> 1.1.0
Requires:         jposug/library/ruby/docile-23jposug
# json < 3, >= 1.8
Requires:         jposug/library/ruby/json-23jposug
# simplecov-html ~> 0.10.0
Requires:         jposug/library/ruby/simplecov-html-23jposug
# Requires:         library/ruby/%{gemname}
...
# docile ~> 1.1.0
Requires:         jposug/library/ruby/docile-24jposug
# json < 3, >= 1.8
Requires:         jposug/library/ruby/json-24jposug
# simplecov-html ~> 0.10.0
Requires:         jposug/library/ruby/simplecov-html-24jposug
# Requires:         library/ruby/%{gemname}
...
# docile ~> 1.1.0
Requires:         jposug/library/ruby/docile-25jposug
# json < 3, >= 1.8
Requires:         jposug/library/ruby/json-25jposug
# simplecov-html ~> 0.10.0
Requires:         jposug/library/ruby/simplecov-html-25jposug
# Requires:         library/ruby/%{gemname}
...
# docile ~> 1.1.0
Requires:         jposug/library/ruby/docile-26jposug
# json < 3, >= 1.8
Requires:         jposug/library/ruby/json-26jposug
# simplecov-html ~> 0.10.0
Requires:         jposug/library/ruby/simplecov-html-26jposug
# Requires:         library/ruby/%{gemname}
