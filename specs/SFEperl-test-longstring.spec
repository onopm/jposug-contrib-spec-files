...
%define sfe_cpan_name test-longstring
%define ips_cpan_name test-longstring
...
Source0:               http://cpan.metacpan.org/authors/id/R/RG/RGARCIA/Test-LongString-%{version}.tar.gz
