#
# spec file for package PostgreSQL 10
#
...
Source1:		 postgres-10-postgres_10
Source2:		 postgres-10-postgresql_10.xml
Source3:		 postgres-10-auth_attr
Source4:		 postgres-10-prof_attr
Source5:		 postgres-10-exec_attr
Source6:		 postgres-10-user_attr
...
IPS_package_name: database/postgres-10/library
Summary: PostgreSQL client libraries
Requires: %{pnm_requires_SUNWlibms}
Requires: %{pnm_requires_SUNWcsl}

%package -n %{prefix_name}-pl
IPS_package_name: database/postgres-10/language-bindings
...
IPS_package_name: database/postgres-10/developer
...
IPS_package_name: database/postgres-10/documentation
Summary: PostgreSQL documentation and man pages

%package -n %{prefix_name}-server
IPS_package_name: service/database/postgres-10
...
cp %{SOURCE1} $RPM_BUILD_ROOT/lib/svc/method/postgres_10
chmod +x $RPM_BUILD_ROOT/lib/svc/method/postgres_10
mkdir -p $RPM_BUILD_ROOT/var/svc/manifest/application/database/
cp %{SOURCE2} $RPM_BUILD_ROOT/var/svc/manifest/application/database/postgresql_10.xml

# attribute
mkdir -p $RPM_BUILD_ROOT/etc/security/auth_attr.d/
cp %{SOURCE3} $RPM_BUILD_ROOT/etc/security/auth_attr.d/service\%2Fdatabase\%2Fpostgres-10
mkdir -p $RPM_BUILD_ROOT/etc/security/exec_attr.d/
cp %{SOURCE4} $RPM_BUILD_ROOT/etc/security/exec_attr.d/service\%2Fdatabase\%2Fpostgres-10
mkdir -p $RPM_BUILD_ROOT/etc/security/prof_attr.d/
cp %{SOURCE5} $RPM_BUILD_ROOT/etc/security/prof_attr.d/service\%2Fdatabase\%2Fpostgres-10
mkdir -p $RPM_BUILD_ROOT/etc/user_attr.d/
cp %{SOURCE5} $RPM_BUILD_ROOT/etc/user_attr.d/service\%2Fdatabase\%2Fpostgres-10
...
ln -fs ../postgres/%{major_version}/bin/pg_receivewal .
ln -fs ../postgres/%{major_version}/bin/pg_recvlogical .
ln -fs ../postgres/%{major_version}/bin/pg_resetwal .
...
ln -fs ../postgres/%{major_version}/bin/pg_waldump .
...
ln -fs ../postgres/%{major_version}/bin/%{_arch64}/pg_receivewal
ln -fs ../postgres/%{major_version}/bin/%{_arch64}/pg_recvlogical
ln -fs ../postgres/%{major_version}/bin/%{_arch64}/pg_resetwal
...
ln -fs ../postgres/%{major_version}/bin/%{_arch64}/pg_waldump
...
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/%{_arch64}/pg_receivewal
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/%{_arch64}/pg_recvlogical
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/%{_arch64}/pg_resetwal
...
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/%{_arch64}/pg_waldump
...
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/pg_receivewal
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/pg_recvlogical
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/pg_resetwal
...
%attr (0555, root, bin) %{_prefix}/%{major_version}/bin/pg_waldump
...
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/%{_arch64}/pg_receivewal
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/%{_arch64}/pg_recvlogical
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/%{_arch64}/pg_resetwal
...
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/%{_arch64}/pg_waldump
...
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/pg_receivewal
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/pg_recvlogical
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/pg_resetwal
...
%attr (0555, root, bin) %ips_tag (mediator=postgres mediator-version=%{major_version}) /usr/bin/pg_waldump
...
%attr (0644, root, other) %{_prefix}/%{major_version}/share/locale/*/LC_MESSAGES/pg_resetwal-%{major_version}.mo
%attr (0644, root, other) %{_prefix}/%{major_version}/share/locale/*/LC_MESSAGES/pg_rewind-%{major_version}.mo
%attr (0644, root, other) %{_prefix}/%{major_version}/share/locale/*/LC_MESSAGES/pg_test_fsync-%{major_version}.mo
%attr (0644, root, other) %{_prefix}/%{major_version}/share/locale/*/LC_MESSAGES/pg_test_timing-%{major_version}.mo
%attr (0644, root, other) %{_prefix}/%{major_version}/share/locale/*/LC_MESSAGES/pg_waldump-%{major_version}.mo
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/bloom.so
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libecpg.so.6.10
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libecpg_compat.so.3.10
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libpgtypes.so.3.10
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libpq.so.5.10
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/libpgfeutils.a
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/bloom.so
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg.so.6.10
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libecpg_compat.so.3.10
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgcommon.a
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgtypes.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgtypes.so.3
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgtypes.so.3.10
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpq.so.5.10
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/libpgfeutils.a
...
%dir %attr (0755, root, bin) %{_prefix}/%{major_version}/include/server/fe_utils
...
%dir %attr (0755, root, bin) %{_prefix}/%{major_version}/include/server/port/atomics
...
%attr (0644, root, bin) %{_prefix}/%{major_version}/include/server/statistics/*.h
...
%dir %attr (0755, root, bin) %{_prefix}/%{major_version}/lib/%{_arch64}/pkgconfig
...
%attr (0555, root, bin) /lib/svc/method/postgres_10
%attr (0644, root, sys) /etc/security/auth_attr.d/service\%2Fdatabase\%2Fpostgres-10
%attr (0644, root, sys) /etc/security/exec_attr.d/service\%2Fdatabase\%2Fpostgres-10
%attr (0644, root, sys) /etc/security/prof_attr.d/service\%2Fdatabase\%2Fpostgres-10
%attr (0644, root, sys) /etc/user_attr.d/service\%2Fdatabase\%2Fpostgres-10
%class(manifest) %attr (0444, root, sys) /var/svc/manifest/application/database/postgresql_10.xml
...
%{_prefix}/%{major_version}/lib/amcheck.so
...
%{_prefix}/%{major_version}/lib/pg_prewarm.so
...
%{_prefix}/%{major_version}/lib/pgoutput.so
...
%{_prefix}/%{major_version}/lib/test_decoding.so
...
%{_prefix}/%{major_version}/lib/%{_arch64}/amcheck.so
...
%{_prefix}/%{major_version}/lib/%{_arch64}/pgoutput.so
...
%{_prefix}/%{major_version}/share/extension/btree_gin--1.0--1.1.sql
%{_prefix}/%{major_version}/share/extension/btree_gin--1.1--1.2.sql
...
%{_prefix}/%{major_version}/share/extension/btree_gist--1.2--1.3.sql
%{_prefix}/%{major_version}/share/extension/btree_gist--1.3--1.4.sql
%{_prefix}/%{major_version}/share/extension/btree_gist--1.4--1.5.sql
...
%{_prefix}/%{major_version}/share/extension/citext--1.3--1.4.sql
%{_prefix}/%{major_version}/share/extension/citext--1.4.sql
...
%{_prefix}/%{major_version}/share/extension/dblink--1.0--1.1.sql
%{_prefix}/%{major_version}/share/extension/dblink--1.1--1.2.sql
%{_prefix}/%{major_version}/share/extension/dblink--1.2.sql
...
%{_prefix}/%{major_version}/share/extension/hstore--1.2--1.3.sql
%{_prefix}/%{major_version}/share/extension/hstore--1.3--1.4.sql
%{_prefix}/%{major_version}/share/extension/hstore--1.4.sql
...
%{_prefix}/%{major_version}/share/extension/pageinspect--1.0--1.1.sql
%{_prefix}/%{major_version}/share/extension/pageinspect--1.1--1.2.sql
%{_prefix}/%{major_version}/share/extension/pageinspect--1.2--1.3.sql
%{_prefix}/%{major_version}/share/extension/pageinspect--1.3--1.4.sql
%{_prefix}/%{major_version}/share/extension/pageinspect--1.4--1.5.sql
%{_prefix}/%{major_version}/share/extension/pageinspect--1.5.sql
%{_prefix}/%{major_version}/share/extension/pageinspect--1.5--1.6.sql
...
%{_prefix}/%{major_version}/share/extension/pg_buffercache--1.2--1.3.sql
...
%{_prefix}/%{major_version}/share/extension/pg_freespacemap--1.1--1.2.sql
...
%{_prefix}/%{major_version}/share/extension/pg_stat_statements--1.1--1.2.sql
%{_prefix}/%{major_version}/share/extension/pg_stat_statements--1.2--1.3.sql
...
%{_prefix}/%{major_version}/share/extension/pg_trgm--1.2--1.3.sql
%{_prefix}/%{major_version}/share/extension/pg_trgm--1.3.sql
...
%{_prefix}/%{major_version}/share/extension/pg_visibility--1.1--1.2.sql
%{_prefix}/%{major_version}/share/extension/pg_visibility.control
%{_prefix}/%{major_version}/share/extension/pgcrypto--1.0--1.1.sql
%{_prefix}/%{major_version}/share/extension/pgcrypto--1.1--1.2.sql
%{_prefix}/%{major_version}/share/extension/pgcrypto--1.2--1.3.sql
%{_prefix}/%{major_version}/share/extension/pgcrypto--1.3.sql
%{_prefix}/%{major_version}/share/extension/pgcrypto--unpackaged--1.0.sql
%{_prefix}/%{major_version}/share/extension/pgcrypto.control
%{_prefix}/%{major_version}/share/extension/pgrowlocks--1.0--1.1.sql
%{_prefix}/%{major_version}/share/extension/pgrowlocks--1.1--1.2.sql
%{_prefix}/%{major_version}/share/extension/pgrowlocks--1.2.sql
...
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.0--1.1.sql
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.1--1.2.sql
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.2--1.3.sql
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.3--1.4.sql
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.4.sql
%{_prefix}/%{major_version}/share/extension/pgstattuple--1.4--1.5.sql
...
%attr (0644, root, other) %{_prefix}/%{major_version}/share/locale/*/LC_MESSAGES/pg_upgrade-%{major_version}.mo
