...
%define sfe_cpan_name test-harness
%define ips_cpan_name test-harness

Summary:               contributing to TAP::Harness
Name:                  SFEperl-%{sfe_cpan_name}
IPS_package_name:      library/perl-5/%{ips_cpan_name}
Version:               3.42
IPS_component_version: 3.42
License:               perl_5
URL:                   https://metacpan.org/pod/Test::Harness
...
%if %{build510}
build_for 5.10
rm -rf ${RPM_BUILD_ROOT}/usr/perl5/5.10
%endif
...
%if %{build516}
build_for 5.16
rm -rf ${RPM_BUILD_ROOT}/usr/perl5/5.16
%endif

%if %{build522}
build_for 5.22
rm -rf ${RPM_BUILD_ROOT}/usr/perl5/5.22
%endif

%if %{build526}
build_for 5.26
rm -rf ${RPM_BUILD_ROOT}/usr/perl5/5.26
%endif

%if %{build526jposug}
build_for 5.26jposug
rm -rf ${RPM_BUILD_ROOT}/opt/jposug/perl5/5.26
%endif
...
%changelog
* Tue May 22 2018 - Fumhisa TONAKA <fumi.ftnk@gmail.com>
- bump to 3.42 and packages for perl-526{,jposug} are added
...
- bump to 3.35 and build packages for perl-516 and perl-520
