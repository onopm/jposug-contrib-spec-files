...
%define sfe_cpan_name carp
%define ips_cpan_name carp
...
License:               perl_5
URL:                   https://metacpan.org/pod/Carp
Source0:               http://cpan.metacpan.org/authors/id/X/XS/XSAWYERX/Carp-%{version}.tar.gz
...
- bump to 1.50 and build only for JPOSUG Perl packages
...
- add packages for perl-510 and perl-520
- fix build
* Tue Nov 10 2015 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.38 and build packages for perl-516 and perl-520
