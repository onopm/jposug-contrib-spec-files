...
%define sfe_cpan_name test-sharedfork
...
License:               perl_5
URL:                   https://metacpan.org/pod/Test::SharedFork
Source0:               http://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test-SharedFork-%{version}.tar.gz
...
- bump to 0.34 and build packages for perl-516 and perl-520
