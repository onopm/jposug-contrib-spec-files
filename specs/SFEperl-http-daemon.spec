#
# spec file for package: SFEperl-http-daemon
#
...
%define tarball_name    HTTP-Daemon

Name:		SFEperl-http-daemon
IPS_package_name: library/perl-5/http-daemon
Version:	6.01
...
Source0:	http://search.cpan.org/CPAN/authors/id/G/GA/GAAS/HTTP-Daemon-%{tarball_version}.tar.gz
...
%package 584
IPS_package_name: library/perl-5/http-daemon-584
Summary: Base class for simple HTTP servers for perl-584
BuildRequires:	runtime/perl-584
...
%package 512
IPS_package_name: library/perl-5/http-daemon-512
Summary: Base class for simple HTTP servers for perl-512
BuildRequires:	runtime/perl-512
