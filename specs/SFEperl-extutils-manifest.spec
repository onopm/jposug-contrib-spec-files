...
%define sfe_cpan_name extutils-manifest
%define ips_cpan_name extutils-manifest
...
Source0:               http://cpan.metacpan.org/authors/id/B/BI/BINGOS/ExtUtils-Manifest-%{version}.tar.gz
...
- bump to 1.71 and build packages for perl-526{,jposug}
