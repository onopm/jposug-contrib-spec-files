...
%package 584
IPS_package_name: library/perl-5/http-date-584
Summary: Date conversion for HTTP date formats for perl-584
BuildRequires:	runtime/perl-584
Requires:	runtime/perl-584

%package 512
IPS_package_name: library/perl-5/http-date-512
Summary: Date conversion for HTTP date formats for perl-512
BuildRequires:	runtime/perl-512
