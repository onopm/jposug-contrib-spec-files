...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/bloom.so
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libecpg.so.6.8
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libecpg_compat.so.3.8
...
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpgtypes.so.3.7
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so.5
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpq.so.5.9
%attr (0755, root, bin) %{_prefix}/%{major_version}/lib/amd64/libpgfeutils.a
