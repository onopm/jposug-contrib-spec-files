...
%define sfe_cpan_name comp-raw-zlib
%define ips_cpan_name compress-raw-zlib
...
Source0:               http://cpan.metacpan.org/authors/id/P/PM/PMQS/Compress-Raw-Zlib-%{version}.tar.gz
...
- bump to 2.081 and add package for perl-526jposug
* Thu Mar 15 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 2.076 and build packages for perl-522 and perl-526
