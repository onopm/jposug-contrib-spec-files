...
%define cpan_name IO
%define sfe_cpan_name io
%define ips_cpan_name io
...
Source0:               http://cpan.metacpan.org/authors/id/T/TO/TODDR/IO-%{version}.tar.gz
...
- bump to 1.42 and only build for JPOSUG perl packages
* Wed May 23 2018 - Fumihisa TONAKA <fumi.ftnk@gmail.com>
- bump to 1.39 and add packages for perl-526{,jposug}
