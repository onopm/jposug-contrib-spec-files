...
%define sfe_cpan_name io-socket-ssl
%define ips_cpan_name io-socket-ssl
...
Source0:               http://cpan.metacpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-%{version}.tar.gz
...
%if %{enable_test}
BuildRequires:    library/perl-5/mozilla-ca-584
BuildRequires:    library/perl-5/net-ssleay-584
...
%if %{enable_test}
BuildRequires:    library/perl-5/mozilla-ca-510
BuildRequires:    library/perl-5/net-ssleay-510
...
%if %{enable_test}
BuildRequires:    library/perl-5/mozilla-ca-512
...
Requires:         library/perl-5/%{ips_cpan_name}
%if %{enable_test}
BuildRequires:    library/perl-5/mozilla-ca-516
BuildRequires:    library/perl-5/net-ssleay-516
...
%if %{enable_test}
BuildRequires:    library/perl-5/mozilla-ca-522
BuildRequires:    library/perl-5/net-ssleay-522
BuildRequires:    library/perl-5/scalar-list-utils-522
%endif
Requires:         runtime/perl-522 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/mozilla-ca-522
Requires:         library/perl-5/net-ssleay-522
...
%if %{enable_test}
BuildRequires:    library/perl-5/mozilla-ca-526
BuildRequires:    library/perl-5/net-ssleay-526
BuildRequires:    library/perl-5/scalar-list-utils-526
%endif
Requires:         runtime/perl-526 = *
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/mozilla-ca-526
Requires:         library/perl-5/net-ssleay-526
...
%if %{enable_test}
BuildRequires:    library/perl-5/mozilla-ca-526jposug
...
Requires:         library/perl-5/%{ips_cpan_name}
Requires:         library/perl-5/mozilla-ca-526jposug
Requires:         library/perl-5/net-ssleay-526jposug
