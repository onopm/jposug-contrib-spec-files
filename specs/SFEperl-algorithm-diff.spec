...
%define sfe_cpan_name algorithm-diff
%define ips_cpan_name algorithm-diff

Summary:               Compute `intelligent' differences between two files / lists but use the old (<=0.59) interface.
...
Source0:               http://cpan.metacpan.org/authors/id/T/TY/TYEMQ/Algorithm-Diff-%{version}.tar.gz
...
- bump to 1.1903 and build packages for perl-516 and perl-520
